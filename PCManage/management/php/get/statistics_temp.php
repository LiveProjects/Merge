...
if ($type=='excel'){
	...
	*/
	...
	foreach ($data as $excel_k=>$excel_v){
		...
		->setCellValue(getCells(++$index).$j,$excel_v['FNum'])
		->setCellValue(getCells(++$index).$j,$excel_v['FRDate'])
		->setCellValue(getCells(++$index).$j,$excel_v['FRTime'])
		->setCellValue(getCells(++$index).$j,$excel_v['FStartStop'])
		->setCellValue(getCells(++$index).$j,$excel_v['FEndStop'])
		->setCellValue(getCells(++$index).$j,$excel_v['FType']);
		++$j;
	}
